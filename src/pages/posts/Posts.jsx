    ...
    <>
      ...
      <div className="w-full min-h-[74vh] p-2 flex flex-col gap-2 rounded-md dark:bg-slate-800 transition-colors">
        ...
        <div className="flex flex-col gap-1">
          <div className="grid grid-cols-[15%_40%_25%_20%] p-1 text-sm hover:bg-slate-100 border border-[#00000026] rounded-sm dark:border-slate-500 dark:hover:bg-slate-800 transition-colors dark:text-white md:grid-cols-[5%_20%_20%_12%_12%_11%_10%_10%]">
            <div>1</div>
            <div>post title</div>
            <div className="hidden md:flex">contenu</div>
            <div className="hidden md:flex">slug</div>
