  ...
  return (
    <>
      <Title className="flex justify-between ">
        ...
        <Buttons to="create" className="bg-white text-blue-900 font-medium">
          Create Category
        </Buttons>
      </Title>
      ...
      <div className="w-full min-h-[74vh] p-4 flex flex-col gap-1">
        {/* Header */}
        <div className="grid grid-cols-[10%_30%_25%_20%_15%] bg-slate-300 p-1 text-sm font-semibold border rounded-sm">
          <div>Id</div>
          <div>Nom</div>
          <div>Slug</div>
          <div>Date</div>
        ...
        <div className="flex flex-col gap-1">
          <div className="grid grid-cols-[10%_30%_25%_20%_15%] p-1 text-sm border-t hover:bg-slate-100 border rounded-sm">
            <div>1</div>
