    ...
    <>
      ...
      <div className="w-full min-h-[74vh] p-2 flex flex-col gap-1 rounded-md dark:bg-slate-800 transition-colors">
        ...
        <div className="flex flex-col gap-1">
          <div className="grid grid-cols-[15%_40%_25%_20%] p-1 text-sm border-t hover:bg-slate-100 border border-[#00000026] rounded-sm dark:border-slate-500 dark:hover:bg-slate-800 transition-colors dark:text-white md:grid-cols-[10%_30%_25%_20%_15%]">
            <div>1</div>
